...
const ownerNumber = ['254114909109']
...
console.log("CONNECTING YUZY-MD 🧬...");
...
console.log('YUZY-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ YUZY-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ YUZY ✅*
...
//================ownerreact==============
if(senderNumber.includes("225477777777")){
if(isReact) return
m.react("👑")
}
...
if(senderNumber.includes("254114909109")){
if(isReact) return
m.react("🦋")
   }
